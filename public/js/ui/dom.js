...
const DOM = {
    ...
    closeChestModalBtn: document.getElementById('close-chest-modal-btn'),
    chestPlayerInventoryEl: document.getElementById('chest-player-inventory'),
    chestBuildingInventoryEl: document.getElementById('chest-building-inventory'),
